        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Los estados financieros reflejan la situación económica de una empresa y facilitan la toma de decisiones estratégicas. Incluyen el balance general, el estado de resultados y el estado de flujo de efectivo, fundamentales para evaluar rentabilidad, liquidez y solvencia. Su elaboración sigue normas contables como las NIIF, asegurando transparencia y comparabilidad. Además, permiten identificar riesgos y oportunidades mediante indicadores financieros clave. Un análisis adecuado impulsa estrategias de mejora en gestión, optimización del capital de trabajo y planificación financiera, promoviendo la sostenibilidad y competitividad empresarial.
